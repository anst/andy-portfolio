<?php
$streak_config = array(
	"streak_blog_author" => "andy",
	"streak_blog_name" => "Andy Sturzu", //your awesome blog name
	"streak_blog_description" => "", //your awesome blog description
	"streak_url" => "http://sturzu.org/", //your awesome blog url (your root domain url)
	...
	"streak_enable_markdown" => FALSE, //do you want to enable markdown? TRUE or FALSE
